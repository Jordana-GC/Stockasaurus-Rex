#Script for running last weight through webcam
import torch
import cv2
import time
import numpy as np
...
model = torch.hub.load(r'C:\Users\jorda\Desktop\Stockasaurus-Rex\YOLOv2\yolov5', 'custom', path=r'C:\Users\jorda\Desktop\Stockasaurus-Rex\YOLOv2\yolov5\runs\train\exp3\weights\last.pt', source='local')
